...
if __name__ == "__main__":
    ...
    [convert(elem) for elem in tqdm(audio_orig, total=len(audio_orig), desc="Convert to 16k sr")]
    ...
    for audio_path in tqdm(audio_paths, total=len(audio_paths), desc='CREMA-D audios'):
